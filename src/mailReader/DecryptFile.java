...
public class DecryptFile extends javax.swing.JFrame {
    ...
    public DecryptFile(MainForm parent) {
        this.parent = parent;
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jPanel4.setForeground(new java.awt.Color(102, 102, 0));

        jLabel9.setForeground(new java.awt.Color(240, 240, 240));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("DECRYPTION PARAMETERS");
        ...
        jButton1.setText("D E C R Y P T    F I L E");
                    ...
                    .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                        ...
                        .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel4Layout.createSequentialGroup()
                            ...
                            .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                ...
                                .add(jTextPrivateKey, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel4Layout.linkSize(new java.awt.Component[] {jTextModulus, jTextPrivateKey}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
        ...
        jPanel4Layout.linkSize(new java.awt.Component[] {jButton2, jButton3, jButton4, jLabel3, jLabel4, jLabel5, jLabel6, jLabel9, jTextDestinationFile, jTextModulus, jTextPrivateKey, jTextSourceFile}, org.jdesktop.layout.GroupLayout.VERTICAL);
...
// TODO add your handling code here:
        jTextPrivateKey.setText("" + parent.db.rsaPrivate);
...
// TODO add your handling code here:
        ...
        try
        {
            privateKey = Long.parseLong(jTextPrivateKey.getText());
        ...
        catch(Exception e)
        {
            ...
            privateKey = 2753;
            modulus = 3233;
            jTextPrivateKey.setText("" + privateKey);
            jTextModulus.setText("" + modulus);
        }
        
        PGPEncDec pgp1 = new PGPEncDec(privateKey,modulus);
        ...
        long len = f1.available()/8;
        for(long i=0;i<len;i++) {
            l = f1.readLong();
            b = (byte)pgp1.process(l);
            f2.writeByte(b);
        }
        f1.closeRead();
        f2.closeWrite();
        addText("Decryption Successful!");
